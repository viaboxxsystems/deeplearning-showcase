...
from model import DenseNet201, get_difference_in_seconds, append_row_to_csv

DEFAULT_DATE_TIME_FORMAT = "%Y%m%d-%H%M%S.%s"


complete_run_time_details_file_name = "DenseNet201_complete_run_timing_" + datetime.now().strftime(DEFAULT_DATE_TIME_FORMAT) + ".csv"
