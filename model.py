...
class BaseModel(ABC):
    ...
    def train(self, t_start, epochs, batch_size, training, validation):
        ...
        checkpoint_callback = ModelCheckpoint(self.file_checkpoints, monitor='val_acc', verbose=1, save_best_only=True,
                                              mode='max')
...
class ResNet50(BaseModel):
    def __init__(self):
        self.net = RN(include_top=False, input_tensor=None, input_shape=(IMAGE_SIZE[0], IMAGE_SIZE[1], 3))
...
class DenseNet121(BaseModel):
    def __init__(self):
        self.net = DENS121(include_top=False, input_tensor=None, input_shape=(IMAGE_SIZE[0], IMAGE_SIZE[1], 3))
...
class DenseNet169(BaseModel):
    def __init__(self):
        self.net = DENS169(include_top=False, input_tensor=None, input_shape=(IMAGE_SIZE[0], IMAGE_SIZE[1], 3))
...
class DenseNet201(BaseModel):
    def __init__(self):
        self.net = DENS201(include_top=False, input_tensor=None, input_shape=(IMAGE_SIZE[0], IMAGE_SIZE[1], 3))
...
class InceptionV3(BaseModel):
    def __init__(self):
        self.net = INS3(include_top=False, input_tensor=None, input_shape=(IMAGE_SIZE[0], IMAGE_SIZE[1], 3))
...
class MobileNet(BaseModel):
    def __init__(self):
        self.net = MOB(include_top=False, input_tensor=None, input_shape=(IMAGE_SIZE[0], IMAGE_SIZE[1], 3))
...
class MobileNetV2(BaseModel):
    def __init__(self):
        self.net = MOBv2(include_top=False, input_tensor=None, input_shape=(IMAGE_SIZE[0], IMAGE_SIZE[1], 3))
...
class InceptionResNetV2(BaseModel):
    def __init__(self):
        self.net = IRNV2(include_top=False, input_tensor=None, input_shape=(IMAGE_SIZE[0], IMAGE_SIZE[1], 3))
