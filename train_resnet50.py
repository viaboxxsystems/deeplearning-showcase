...
from model import ResNet50, get_difference_in_seconds, append_row_to_csv

DEFAULT_DATE_TIME_FORMAT = "%Y%m%d-%H%M%S"

complete_run_time_details_file_name = "ResNet50_complete_run_timing_" + datetime.now().strftime(DEFAULT_DATE_TIME_FORMAT) + ".csv"
